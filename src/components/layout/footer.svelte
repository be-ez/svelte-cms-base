<script lang="ts">
	...
	const socials = [
		{ name: 'GitHub', href: 'https://github.com/alexshulman', icon: '💻' },
		{ name: 'LinkedIn', href: 'https://www.linkedin.com/in/shulmanalex/', icon: '💼' },
		{ name: 'Instagram', icon: '📸', href: 'https://instagram.com/dooooooo_ooooooood' }
	];
</script>
